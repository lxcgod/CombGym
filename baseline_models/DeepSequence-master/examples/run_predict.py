...
data_params = {"alignment_file":"/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/SaCas9-KKH_b0.7.a2m"}

pabp_data_helper = helper.DataHelper(
                alignment_file=data_params["alignment_file"],
                working_dir="/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master",
                calc_weights=False
                )
...
pabp_custom_matr_mutant_name_list, pabp_custom_matr_delta_elbos \
    = pabp_data_helper.custom_mutant_matrix("baseline_mutations/SaCas9_mean.csv", \
                                            pabp_vae_model, N_pred_iterations=500)
with open('/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_results/SaCas9-KKH_b0.7.csv', 'w', newline='') as f:
    writer = csv.writer(f)
