...
class DataHelper:
    ...
    def configure_datasets(self):
        ...
        if self.dataset == "SpCas9_b0.5":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/SpCas9_b0.5.a2m"
            self.theta = 0.2
        
        if self.dataset == "mTagBFP2_b0.5":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/mTagBFP2_b0.5.a2m"
            self.theta = 0.2

        elif self.dataset == "bnAbs_CR6261_b0.3":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/bnAbs_CR6261_b0.3.a2m"
            self.theta = 0.2
        
        elif self.dataset == "bnAbs_CR6261_b0.5":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/bnAbs_CR6261_b0.5.a2m"
            self.theta = 0.2

        elif self.dataset == "bnAbs_CR6261_b0.7":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/bnAbs_CR6261_b0.7.a2m"
            self.theta = 0.2
        
        elif self.dataset == "bnAbs_CR9114_b0.3":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/bnAbs_CR9114_b0.3.a2m"
            self.theta = 0.2
        
        elif self.dataset == "bnAbs_CR9114_b0.5":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/bnAbs_CR9114_b0.5.a2m"
            self.theta = 0.2
        
        elif self.dataset == "bnAbs_CR9114_b0.7":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/bnAbs_CR9114_b0.7.a2m"
            self.theta = 0.2
        
        elif self.dataset == "SaCas9-KKH_b0.3":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/SaCas9-KKH_b0.3.a2m"
            self.theta = 0.2

        elif self.dataset == "SaCas9-KKH_b0.5":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/SaCas9-KKH_b0.5.a2m"
            self.theta = 0.2
        
        elif self.dataset == "SaCas9-KKH_b0.7":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/baseline_datasets/SaCas9-KKH_b0.7.a2m"
            self.theta = 0.2
        ...
        elif self.dataset == "rhla":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/Q51559_b0.5.a2m"
            self.theta = 0.2

        elif self.dataset == "YAP1_WW1":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/YAP1_WW1.a2m"
            self.theta = 0.2   

        elif self.dataset == "TEM1":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/TEM1.a2m"
            self.theta = 0.2
        
        elif self.dataset == "PTEN":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/PTEN.a2m"
            self.theta = 0.2
        
        elif self.dataset == "KKA2_KLEPN_KAN18":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/KKA2_KLEPN_KAN18.a2m"
            self.theta = 0.2
        
        elif self.dataset == "HSP90":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/HSP90.a2m"
            self.theta = 0.2
        
        elif self.dataset == "AMIE_acet":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/AMIE_acet.a2m"
            self.theta = 0.2
        
        elif self.dataset == "AVGFP":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/AMIE_acet.a2m"
            self.theta = 0.2
        
        elif self.dataset == "B3VI55_LIPSTSTABLE":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/B3VI55_LIPSTSTABLE.a2m"
            self.theta = 0.2

        elif self.dataset == "BG_STRSQ":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/B3VI55_LIPSTSTABLE.a2m"
            self.theta = 0.2
        
        elif self.dataset == "cov2_ace2_bind":
            self.alignment_file = "/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/datasets/cov2_ace2_bind.a2m"
            self.theta = 0.2
