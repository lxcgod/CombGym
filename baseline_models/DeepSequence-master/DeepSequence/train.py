...
def train(data,
    ...
    if save_progress:
        err_filename = data.working_dir+"/examples/logs/"+job_string+"_err.csv"
        with open('/thinker/glusterfs/home/TSLab-xcLu/DeepSequence-master/DeepSequence-master/examples/logs/err830.csv', 'w', newline='') as OUTPUT:
