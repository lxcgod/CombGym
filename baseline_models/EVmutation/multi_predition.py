...
c = CouplingsModel("baseline_parameters/HIV-1_b0.5.model_params")
datas = []
with open('baseline_mutant/HIV-1.csv', 'r') as f:
    reader = csv.reader(f)
    next(reader)  
...
df.to_csv('baseline_result/HIV-1_b0.5.csv', index=False)